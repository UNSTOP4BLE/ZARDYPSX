	...
	//Fallthrough
		...
		case MenuPage_Story:
		{
			static const struct
			{
				...
				{NULL, StageId_1_1, "ZARDY MOMENT", {" "}},
				{"1", StageId_2_1, "ZARDY MOMENT", {" "}},
			};
		...
		case MenuPage_Freeplay:
		{
			static const struct
			{
				...
				//{StageId_4_4, "TEST"},
				{StageId_1_1, "FOOLHARDY"},
				{StageId_2_1, "BUSHWHACK"},
				{StageId_1_2, "RETROSPECTER REMIX"},
			};
		...
		case MenuPage_Mods:
		{
			static const struct
			{
				...
				{StageId_Clwn_2, "	OG ZARDY MOD", false},
				{StageId_Clwn_2, "SWANKYBOX", false},
				{StageId_Clwn_2, "ROZEBUD", false},
				{StageId_Clwn_2, "STARNYART", false},
				{StageId_Clwn_2, "KADEDEV", false},
				{StageId_Clwn_2, "SUGARRATIO", false},
				{StageId_Clwn_2, "JADS", false},
				{StageId_Clwn_2, "CHARRIII", false},
				{StageId_Clwn_2, "TURVIE", false},
