	{ //StageId_1_1 (Bopeebo)
		...
		{Char_Zardy_New, FIXED_DEC(-120,1),  FIXED_DEC(100,1)},
		...
		//Song info
		{FIXED_DEC(1,1),FIXED_DEC(29,10),FIXED_DEC(13,10)},
		1, 1,
		XA_Bopeebo, 0,
	...
	{ //StageId_1_2 (Fresh)
		...
		//Song info
		{FIXED_DEC(1,1),FIXED_DEC(35,10),FIXED_DEC(18,10)},
		1, 2,
		XA_Fresh, 2,
	...
	{ //StageId_2_1 (Spookeez)
		...
		{Char_XmasP_New,  FIXED_DEC(-90,1),   FIXED_DEC(85,1)},
		{Char_GF_New,       FIXED_DEC(0,1),  FIXED_DEC(-1500,1)},
